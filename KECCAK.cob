...
*> Program:      KECCAK.cob
*>
*> Purpose:      This module computes the Keccak[r,c] sponge function 
*>               over a given input.
*>
...
*>
*> Tectonics:    cobc -c -free KECCAK.cob
*>
*> Usage:        This module will be called in SHA3 and SHAKE modules.
*>
...
*>               - LNK-KECCAK-OUTPUT-BYTE-LEN: The number of output bytes 
*>                 desired.
*>******************************************************************************
